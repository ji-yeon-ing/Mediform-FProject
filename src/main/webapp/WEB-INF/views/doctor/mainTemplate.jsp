...
<body>
	...
	<main class="main" id="top">
        ...
        <div class="doctorContent pb-0s">
        
			<tiles:insertAttribute name="doctorHeader"/>
          
          	<tiles:insertAttribute name="doctorContent"/>
		...
		<div class="offcanvas-body scrollbar-overlay px-x1 h-100"
				...
				<div class="row gx-2">
					<div class="col-4">
						<input class="btn-check" id="themeSwitcherLight"
							...
							class="hover-overlay mb-2 rounded d-block"><img
								...
								src="../../resources/assets/img/generic/falcon-mode-default.jpg"
					...
					<div class="col-4">
						<input class="btn-check" id="themeSwitcherDark" name="theme-color"
							...
							class="hover-overlay mb-2 rounded d-block"><img
								class="img-fluid img-prototype mb-0"
								src="../../resources/assets/img/generic/falcon-mode-dark.jpg"
					...
					<div class="col-4">
						<input class="btn-check" id="themeSwitcherAuto" name="theme-color"
							...
							class="hover-overlay mb-2 rounded d-block"><img
								class="img-fluid img-prototype mb-0"
								src="../../resources/assets/img/generic/falcon-mode-auto.jpg"
			...
			<div class="d-flex justify-content-between">
				<div class="d-flex align-items-start">
					<img class="me-2"
						src="../../resources/assets/img/icons/left-arrow-from-left.svg"
						width="20" alt="" />
					<div class="flex-1">
						<h5 class="fs-0">RTL Mode</h5>
						<p class="fs--1 mb-0">Switch your language direction</p>
						<a class="fs--1"
							href="../../resources/documentation/customization/configuration.html">RTL
							Documentation</a>
					</div>
				</div>
			...
			<div class="d-flex justify-content-between">
				<div class="d-flex align-items-start">
					<img class="me-2"
						src="../../resources/assets/img/icons/arrows-h.svg" width="20"
						alt="" />
					<div class="flex-1">
						<h5 class="fs-0">Fluid Layout</h5>
						<p class="fs--1 mb-0">Toggle container layout system</p>
						<a class="fs--1"
							href="../../resources/documentation/customization/configuration.html">Fluid
							Documentation</a>
					</div>
				</div>
				<div class="form-check form-switch">
			...
			<div class="d-flex align-items-start">
				<img class="me-2"
					src="../../resources/assets/img/icons/paragraph.svg" width="20"
					alt="" />
				<div class="flex-1">
					<h5 class="fs-0 d-flex align-items-center">Navigation Position</h5>
					<p class="fs--1 mb-2">Select a suitable navigation system for
						your web application</p>
					<p class="text-warning fs--1">You cann't update navigation
						position in an example page</p>
				</div>
			</div>
			<hr />
			...
			<p>
				<a class="fs--1"
					href="../../resources/modules/components/navs-and-tabs/vertical-navbar.html#navbar-styles">See
					Documentation</a>
			</p>
			<p class="text-warning fs--1">You can't change navbar vertical
				style in an example page</p>
				...
				<div class="row gx-2">
					<div class="col-6">
						<input class="btn-check" id="navbar-style-transparent"
							...
							src="../../resources/assets/img/generic/default.png" alt="" /><span
					...
					<div class="col-6">
						<input class="btn-check" id="navbar-style-inverted" type="radio"
							...
							class="img-fluid img-prototype"
							src="../../resources/assets/img/generic/inverted.png" alt="" /><span
					...
					<div class="col-6">
						...
						<label class="btn d-block w-100 btn-navbar-style fs--1"
							...
							class="img-fluid img-prototype"
							src="../../resources/assets/img/generic/card.png" alt="" /><span
					...
					<div class="col-6">
						<input class="btn-check" id="navbar-style-vibrant" type="radio"
							...
							class="img-fluid img-prototype"
							src="../../resources/assets/img/generic/vibrant.png" alt="" /><span
			...
			<div class="text-center mt-5">
				<img class="mb-4"
					src="../../resources/assets/img/icons/spot-illustrations/47.png"
					alt="" width="120" />
	...
	<a class="card setting-toggle" href="#settings-offcanvas"
		data-bs-toggle="offcanvas" style="display: none">
