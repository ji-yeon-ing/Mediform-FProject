...
<body onload="printClock()">
	...
	<div class="user-wrap">
		<div id="date" style="width: 600px; height: 250px; line-height: 150px; color: #666; font-size: 20px; text-align: left;">
			<script>
				const options = {
					weekday : 'long',
					month : 'long',
		...
		<div class="welcome" style="width: 600px; height: 400px; line-height: 400px; color: #666; font-size: 18px; text-align: left;">
			<span class="fw-semi-bold">${customUser.employee.empNm}</span>간호사님. 환영합니다.</span>
		</div>
		<div class="user-time" style="width: 600px; height: 250px; line-height: 300px; color: #666; font-size: 60px; text-align: left;" id="clock"></div>
		...
		<div>
			<img class="main" src="../../resources/assets/img/main.png" style="height: 1000px;" />
		</div>
	</div>
			...
			function() {
				...
				function printClock() {
					...
					clock.innerHTML = currentHours + ":" + currentMinute + ":"
							+ currentSeconds
							+ " <span style='font-size:20px;'>" + amPm
							+ "</span>";
