...
<%--     <script src="${pageContext.request.contextPath }/resources/assets/js/theme.min.js.map"></script> --%>
    <script src="${pageContext.request.contextPath }/resources/assets/js/theme.min.js"></script>
		...
		<div class="row">
			<div class="col-12">
				<div class="swiper-container theme-slider m-0" data-swiper='{"autoplay":false,"spaceBetween":8, "loop":false, "slideToClickedSlide":true}'>
					<div class="swiper-wrapper">
						<div class="swiper-slide"><img class="rounded-1 img-fluid imgPPT" src="${pageContext.request.contextPath }/resources/image/ppt/ppt1.png" alt="" /></div>
						<div class="swiper-slide"><img class="rounded-1 img-fluid imgPPT" src="${pageContext.request.contextPath }/resources/image/ppt/ppt2.png" alt="" /></div>
						<div class="swiper-slide"><img class="rounded-1 img-fluid imgPPT" src="${pageContext.request.contextPath }/resources/image/ppt/ppt4.png" alt="" /></div>
						<div class="swiper-slide"><img class="rounded-1 img-fluid imgPPT" src="${pageContext.request.contextPath }/resources/image/ppt/ppt5.png" alt="" /></div>
						<div class="swiper-slide"><img class="rounded-1 img-fluid imgPPT" src="${pageContext.request.contextPath }/resources/image/ppt/ppt6.png" alt="" /></div>
						<div class="swiper-slide"><img class="rounded-1 img-fluid imgPPT" src="${pageContext.request.contextPath }/resources/image/ppt/ppt7.png" alt="" /></div>
						<div class="swiper-slide"><img class="rounded-1 img-fluid imgPPT" src="${pageContext.request.contextPath }/resources/image/ppt/ppt8.png" alt="" /></div>
						<div class="swiper-slide"><img class="rounded-1 img-fluid imgPPT" src="${pageContext.request.contextPath }/resources/image/ppt/ppt9.png" alt="" /></div>
						<div class="swiper-slide">
							<img class="rounded-1 img-fluid imgPPT" src="${pageContext.request.contextPath }/resources/image/ppt/ppt11.png" alt=""/>
							<button class="btn btn-sm btn-falcon-primary" id="goLoginBtn">로그인 페이지로 가기</button>
						</div>
