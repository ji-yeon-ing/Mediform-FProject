                ...
                <div class="row g-0 h-100">
                  <div class="col-md-5 text-center bg-card-gradient">
                    <div class="position-relative p-4 pt-md-5 pb-md-7" data-bs-theme="light">
                      ...
                      <div class="z-1 position-relative"><a class="link-light mb-4 font-sans-serif fs-4 d-inline-block fw-bolder" href="../../../index.html">MEDIFORM</a>
                        <p class="opacity-75 text-white">괜찮냐고 묻지 말고 <br> 괜찮은지 살펴보자</p>
                      </div>
                    </div>
                  ...
                  <div class="col-md-7 d-flex flex-center">
                    <div class="p-4 p-md-5 flex-grow-1">
                      <div class="text-center"><img class="d-block mx-auto mb-4" src="../../../resources/assets/img/icons/spot-illustrations/45.png" alt="shield" width="100" />
                        <h4>정상적으로 로그아웃 되었습니다!</h4>
                        <a class="btn btn-primary btn-sm mt-3" href="/mediform/login"><span class="fas fa-chevron-left me-1" data-fa-transform="shrink-4 down-1"></span>로그인으로 돌아가기</a>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div class="btn-group d-block w-100 btn-group-navbar-style">
          <div class="row gx-2">
            ...
            <div class="col-4">
              ...
              <label class="btn d-inline-block btn-navbar-style fs--1" for="themeSwitcherAuto"> <span class="hover-overlay mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0" src="../../../assets/img/generic/falcon-mode-auto.jpg" alt=""/></span><span class="label-text"> Auto</span></label>
            </div>
          </div>
        </div>
        <hr />
          ...
          <div class="flex-1">
            ...
            <div>
              <select class="form-select form-select-sm" aria-label="Navbar position" data-theme-control="navbarPosition">
                <option value="vertical" data-page-url="../../../resources/modules/components/navs-and-tabs/vertical-navbar.html">Vertical</option>
                <option value="top" data-page-url="../../../resources/modules/components/navs-and-tabs/top-navbar.html">Top</option>
                <option value="combo" data-page-url="../../../resources/modules/components/navs-and-tabs/combo-navbar.html">Combo</option>
                <option value="double-top" data-page-url="../../../resources/modules/components/navs-and-tabs/double-top-navbar.html">Double Top</option>
              </select>
            </div>
          </div>
        </div>
