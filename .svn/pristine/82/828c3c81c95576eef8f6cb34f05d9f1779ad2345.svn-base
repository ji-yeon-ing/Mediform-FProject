...
body {
  ...
  <head>
    ...
    <link href="${pageContext.request.contextPath }/resources/assets/css/nurse/main.css" rel="stylesheet" id="user-style-default">
    <link href="${pageContext.request.contextPath }/resources/assets/css/nurse/menu.css" rel="stylesheet" id="user-style-default">
    <link href="${pageContext.request.contextPath }/resources/assets/css/nurse/tab.css" rel="stylesheet" id="user-style-default">
  	<!-- 풀캘린더 -->
	...
	<!-- 페이징 css -->
    <link href="${pageContext.request.contextPath }/resources/assets/css/main/main.css" rel="stylesheet" id="user-style-default">
	
  	<!-- 차트 -->
  	<link href="${pageContext.request.contextPath }/resources/vendors/prism/prism-okaidia.css" rel="stylesheet">
    <link href="${pageContext.request.contextPath }/resources/vendors/simplebar/simplebar.min.css" rel="stylesheet">
  ...
  <body>
  	...
  	<!-- 메뉴 포커스를 위한 히든 -->
	<input type="hidden" id="menuSelected" value="${menuSelected }">
	<input type="hidden" id="subMenuSelected" value="${subMenuSelected }">
    <!-- ===============================================-->
    <!--    Main Content-->
    <!-- ===============================================-->
    <main class="main" id="top">
      <div class="container" data-layout="container">
        ...
        <div class="content pb-0" >
			<tiles:insertAttribute name="therapistHeader"/>
          
          	<tiles:insertAttribute name="therapistContent"/>
	...
	<!-- 화면 사이드바의 화면 다크 모드 양쪽 여백 설정하는 기능 리스트 : 디스플레이 안되게 설정하고 기본 디폴트들 설정함!! 수정&삭제 XXX -->
    <div class="offcanvas offcanvas-end settings-panel border-0" id="settings-offcanvas" tabindex="-1" aria-labelledby="settings-offcanvas">
      ...
      <div class="offcanvas-body scrollbar-overlay px-x1 h-100" id="themeController">
        ...
        <div class="btn-group d-block w-100 btn-group-navbar-style">
          <div class="row gx-2">
            <div class="col-4">
              ...
              <label class="btn d-inline-block btn-navbar-style fs--1" for="themeSwitcherLight"> <span class="hover-overlay mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0" src="../../resources/assets/img/generic/falcon-mode-default.jpg" alt=""/></span><span class="label-text">Light</span></label>
            </div>
            <div class="col-4">
              <input class="btn-check" id="themeSwitcherDark" name="theme-color" type="radio" value="dark" data-theme-control="theme" />
              <label class="btn d-inline-block btn-navbar-style fs--1" for="themeSwitcherDark"> <span class="hover-overlay mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0" src="../../resources/assets/img/generic/falcon-mode-dark.jpg" alt=""/></span><span class="label-text"> Dark</span></label>
            </div>
            <div class="col-4">
              <input class="btn-check" id="themeSwitcherAuto" name="theme-color" type="radio" value="auto" data-theme-control="theme" />
              <label class="btn d-inline-block btn-navbar-style fs--1" for="themeSwitcherAuto"> <span class="hover-overlay mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0" src="../../resources/assets/img/generic/falcon-mode-auto.jpg" alt=""/></span><span class="label-text"> Auto</span></label>
            </div>
          </div>
        </div>
        <hr />
        <div class="d-flex justify-content-between">
          <div class="d-flex align-items-start"><img class="me-2" src="../../resources/assets/img/icons/left-arrow-from-left.svg" width="20" alt="" />
            <div class="flex-1">
              <h5 class="fs-0">RTL Mode</h5>
              <p class="fs--1 mb-0">Switch your language direction </p><a class="fs--1" href="../../resources/documentation/customization/configuration.html">RTL Documentation</a>
            </div>
          </div>
        ...
        <hr />
        <div class="d-flex justify-content-between">
          <div class="d-flex align-items-start"><img class="me-2" src="../../resources/assets/img/icons/arrows-h.svg" width="20" alt="" />
            <div class="flex-1">
              <h5 class="fs-0">Fluid Layout</h5>
              <p class="fs--1 mb-0">Toggle container layout system </p><a class="fs--1" href="../../resources/documentation/customization/configuration.html">Fluid Documentation</a>
            </div>
          </div>
          <div class="form-check form-switch">
        ...
        <hr />
        <div class="d-flex align-items-start"><img class="me-2" src="../../resources/assets/img/icons/paragraph.svg" width="20" alt="" />
          <div class="flex-1">
        ...
        <p> <a class="fs--1" href="../../resources/modules/components/navs-and-tabs/vertical-navbar.html#navbar-styles">See Documentation</a></p>
        <p class="text-warning fs--1">You can't change navbar vertical style in an example page</p>
        <div class="btn-group d-block w-100 btn-group-navbar-style d-none">
          <div class="row gx-2">
            <div class="col-6">
              <input class="btn-check" id="navbar-style-transparent" type="radio" name="navbarStyle" value="transparent" data-theme-control="navbarStyle" />
              <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-transparent"> <img class="img-fluid img-prototype" src="../../resources/assets/img/generic/default.png" alt="" /><span class="label-text"> Transparent</span></label>
            </div>
            <div class="col-6">
              <input class="btn-check" id="navbar-style-inverted" type="radio" name="navbarStyle" value="inverted" data-theme-control="navbarStyle" />
              <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-inverted"> <img class="img-fluid img-prototype" src="../../resources/assets/img/generic/inverted.png" alt="" /><span class="label-text"> Inverted</span></label>
            </div>
            <div class="col-6">
              <input class="btn-check" id="navbar-style-card" type="radio" name="navbarStyle" value="card" data-theme-control="navbarStyle" />
              <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-card"> <img class="img-fluid img-prototype" src="../../resources/assets/img/generic/card.png" alt="" /><span class="label-text"> Card</span></label>
            </div>
            <div class="col-6">
              <input class="btn-check" id="navbar-style-vibrant" type="radio" name="navbarStyle" value="vibrant" data-theme-control="navbarStyle" />
              <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-vibrant"> <img class="img-fluid img-prototype" src="../../resources/assets/img/generic/vibrant.png" alt="" /><span class="label-text"> Vibrant</span></label>
            </div>
          </div>
        </div>
        <div class="text-center mt-5"><img class="mb-4" src="../../resources/assets/img/icons/spot-illustrations/47.png" alt="" width="120" />
    ...
    <!-- 화면 사이드바의 화면 다크 모드 양쪽 여백 설정하는 기능 버튼: 디스플레이 안되게 설정하고 기본 디폴트들 설정함!! 수정&삭제 XXX -->
	...
	<script src="${pageContext.request.contextPath }/resources/assets/js/chart-bar.js"></script>
	<script src="${pageContext.request.contextPath }/resources/assets/js/bar.js"></script>
<%-- 	<script src="${pageContext.request.contextPath }/resources/assets/vendors/chart/chart.min.js"></script> --%>
  ...
  $(function(){
	  $(document).ready(function(){
     		...
     		if(menuSelected != null && menuSelected != ""){
     			$("#" + menuSelected).addClass('menuSelected');
     		}
     		/* 선택된 메뉴바 CSS 종료 */
