						...
						<div class="card-header" style="background-color: midnightblue;">
							<div class="row flex-between-center">
								<div class="col-6 col-sm-auto d-flex align-items-center pe-0">
									<h5
										class="fs-0 mb-0 text-nowrap py-2 py-xl-0 text-white fw-semi-bold">환자목록
									</h5>
								</div>
								...
								<div
									...
									<div class="input-group ">
										<input type="text" name="searchWord" id="searchWord2"
											...
											class="form-control" placeholder="검색할 환자명을 입력해주세요."
														...
														<td class="align-middle white-space-nowrap text-center">
															<div
																...
																<div class="dropdown-menu dropdown-menu-end border py-2"
																	...
																	<button class="patientModal dropdown-item"
			...
			<div class="card border border-secondary" style="height: 820px;">
				<div class="">
					<input
						...
						id="mediformToday" name="" type="text" value="오늘의 현황"
				...
				<div class="container">
					<div class="custom-width-element ">
						...
						<div class="column">
							...
							<div class="table-container scrollbar" style="overflow-y: auto; max-height: 240px;">
								<table class="table table-sm table-striped"
									style="height: 180px;">
									<thead>
										<tr id="" class="bg-light">
...
<!-- ================================= 환자 기록 modal 시작 =================================================-->
		<div class="modal fade" id="patntClnicModal" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true" >
							...
							<form action="/mediform/nurse/patient/insert" method="post"
								...
								<div class="col-md-12">
									<div align="right">
										...
										<button class="btn btn-primary" id="insertBtn" style="background-color: midnightblue;">저장</button>
									</div>
								</div>
								<sec:csrfInput />
							</form>
				...
				<div class="modal-content position-relative">
					<div class="position-absolute top-0 end-0 mt-2 me-2 z-1">
						<button class="btn-close me-n1" type="button"
							data-bs-theme="light" data-bs-dismiss="modal" aria-label="Close"></button>
					</div>
					<div class="modal-body p-0">
						<div class="rounded-top-2 py-2 ps-3 pe-6"
							style="background-color: midnightblue;">
							<h4 class="mb-0 text-white" id="modalExampleDemoLabel">진료
								확인서</h4>
						</div>
									...
									<tr style="height: 80.6pt">
										<td rowspan="4">
											<p class="textCenter"
												...
												<strong><span class="mtcFont mtcTitle">진료
														확인서</span></strong>
											</p>
										</td>
									</tr>
		...
		$.ajax({
			...
			success: function (dataList) {
				...
				if (dataList.length === 0) {
		            htmlStr += `
		                <tr>
		                    <th class="text-center" colspan="10">진료 정보가 없는 환자 입니다.</th>
		                </tr>
		            			`;
		        }else{
				...
				for (let i = 0; i < dataList.length; i++) {
					...
					htmlStr += `
							<tr>
								...
								<th noWrap><button id="\${pc.clnicNo}" class="btn btn-falcon-primary me-1 mb-1 diagnosispage" type="button">진단서</button></th>
								<th noWrap><button id="\${pc.clnicNo}" class="btn btn-falcon-success  me-1 mb-1 mtcpage" type="button">진료확인서</button></th>
								<th noWrap><button id="\${pc.clnicNo}" class="btn btn-falcon-warning  me-1 mb-1 prescriptionpage" type="button">처방전</button></th>
							</tr>
							`;
					}
				}
