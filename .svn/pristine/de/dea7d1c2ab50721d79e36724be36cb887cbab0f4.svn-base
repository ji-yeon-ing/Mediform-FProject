	...
	<div class="row card-body pt-1" style="height: 580px;">
		<div class="col-12">
			<div class="card border my-3">
				<div class="card-body p-5" style="height: 480px; overflow-y: auto;">
				...
				<div class="row ms-3">
					<ul class="mailbox-attachments d-flex align-items-stretch clearfix">
						<c:if test="${not empty noticeBoardVO.fileList }">
							<c:forEach items="${noticeBoardVO.fileList }" var="noticeFile"
								varStatus="vs">
								<li>
									<div class="mailbox-attachment-info">
										<a href="#" class="mailbox-attachment-name"> <i
											class="fas fa-paperclip"></i> ${noticeFile.fileNm }
										</a> <span class="mailbox-attachment-size clearfix mt-1"> <c:url
												value="/notice/download.do?${_csrf.parameterName }=${_csrf.token }"
												var="downloadURL">
