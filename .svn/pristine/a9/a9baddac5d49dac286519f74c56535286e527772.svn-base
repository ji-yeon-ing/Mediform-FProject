  ...
  <body class="overflow-hidden">
                      ...
                      <div class="h-100 overflow-auto scrollbar">
                        <div class="d-flex position-relative align-items-center p-3 border-bottom">
                          ...
                          <div class="flex-1 ms-2 d-flex flex-between-center">
                            <h6 class="mb-0"><a class="text-decoration-none stretched-link text-700" href="${pageContext.request.contextPath }/resources/pages/user/profile.html">Antony Hopkins</a></h6>
                        ...
                        <div class="px-3" id="others-info-0">
                          ...
                          <div class="collapse" id="shared-media-0" aria-labelledby="shared-media-title-0" data-parent="#others-info-0">
                            <div class="row mx-n1">
                              <div class="col-6 col-md-4 px-1"><a href="${pageContext.request.contextPath }/resources/assets/img/chat/1.jpg" data-gallery="images-1"><img class="img-fluid rounded-1 mb-2" src="${pageContext.request.contextPath }/resources/assets/img/chat/1.jpg" alt="" /></a></div>
                              <div class="col-6 col-md-4 px-1"><a href="${pageContext.request.contextPath }/resources/assets/img/chat/2.jpg" data-gallery="images-1"><img class="img-fluid rounded-1 mb-2" src="${pageContext.request.contextPath }/resources/assets/img/chat/2.jpg" alt="" /></a></div>
                              <div class="col-6 col-md-4 px-1"> <a href="${pageContext.request.contextPath }/resources/assets/img/chat/3.jpg" data-gallery="images-1"><img class="img-fluid rounded-1 mb-2" src="${pageContext.request.contextPath }/resources/assets/img/chat/3.jpg" alt="" /></a></div>
                              <div class="col-6 col-md-4 px-1"> <a href="${pageContext.request.contextPath }/resources/assets/img/chat/4.jpg" data-gallery="images-1"><img class="img-fluid rounded-1 mb-2" src="${pageContext.request.contextPath }/resources/assets/img/chat/4.jpg" alt="" /></a></div>
                              <div class="col-6 col-md-4 px-1"> <a href="${pageContext.request.contextPath }/resources/assets/img/chat/5.jpg" data-gallery="images-1"><img class="img-fluid rounded-1 mb-2" src="${pageContext.request.contextPath }/resources/assets/img/chat/5.jpg" alt="" /></a></div>
                              <div class="col-6 col-md-4 px-1"> <a href="${pageContext.request.contextPath }/resources/assets/img/chat/6.jpg" data-gallery="images-1"><img class="img-fluid rounded-1 mb-2" src="${pageContext.request.contextPath }/resources/assets/img/chat/6.jpg" alt="" /></a></div>
                            </div>
                          </div>
                        </div>
                      </div>
                            ...
                            <div class="hover-actions-trigger d-flex flex-end-center">
                              ...
                              <div class="bg-primary text-white p-2 rounded-2 chat-message" data-bs-theme="light">
                                ...
                                <a href="${pageContext.request.contextPath }/resources/assets/img/chat/1.jpg" data-gallery="gallery-3">
                                  <img class="rounded" src="${pageContext.request.contextPath }/resources/assets/img/chat/1.jpg" alt="" width="150">
                                </a>
                        ...
                        <div class="flex-1 d-flex justify-content-end">
                          <div class="w-100 w-xxl-75">
                            <div class="hover-actions-trigger d-flex flex-end-center">
                              ...
                              <div class="bg-primary text-white p-2 rounded-2 chat-message" data-bs-theme="light">Give me the images.
                              </div>
                            </div>
                              ...
                              <div class="chat-message chat-gallery">
                                <div class="row mx-n1">
                                  <div class="col-6 col-md-4 px-1" style="min-width: 50px;">
                                    <a href="${pageContext.request.contextPath }/resources/assets/img/chat/1.jpg" data-gallery="gallery-2"><img src="${pageContext.request.contextPath }/resources/assets/img/chat/1.jpg" alt="" class="img-fluid rounded mb-2"></a>
                                  </div>
                                  <div class="col-6 col-md-4 px-1" style="min-width: 50px;">
                                    <a href="${pageContext.request.contextPath }/resources/assets/img/chat/2.jpg" data-gallery="gallery-2"><img src="${pageContext.request.contextPath }/resources/assets/img/chat/2.jpg" alt="" class="img-fluid rounded mb-2"></a>
                                  </div>
                                  <div class="col-6 col-md-4 px-1" style="min-width: 50px;">
                                    <a href="${pageContext.request.contextPath }/resources/assets/img/chat/3.jpg" data-gallery="gallery-2"><img src="${pageContext.request.contextPath }/resources/assets/img/chat/3.jpg" alt="" class="img-fluid rounded mb-2"></a>
                                  </div>
                                  <div class="col-6 col-md-4 px-1" style="min-width: 50px;">
                                    <a href="${pageContext.request.contextPath }/resources/assets/img/chat/4.jpg" data-gallery="gallery-2"><img src="${pageContext.request.contextPath }/resources/assets/img/chat/4.jpg" alt="" class="img-fluid rounded mb-2 mb-lg-0"></a>
                                  </div>
                                  <div class="col-6 col-md-4 px-1" style="min-width: 50px;">
                                    <a href="${pageContext.request.contextPath }/resources/assets/img/chat/5.jpg" data-gallery="gallery-2"><img src="${pageContext.request.contextPath }/resources/assets/img/chat/5.jpg" alt="" class="img-fluid rounded mb-2 mb-lg-0"></a>
                                  </div>
                                  <div class="col-6 col-md-4 px-1" style="min-width: 50px;">
                                    <a href="${pageContext.request.contextPath }/resources/assets/img/chat/6.jpg" data-gallery="gallery-2"><img src="${pageContext.request.contextPath }/resources/assets/img/chat/6.jpg" alt="" class="img-fluid rounded"></a>
                                  </div>
                                </div>
                              </div>
                              <ul class="hover-actions position-relative list-inline mb-0 text-400 ms-2">
    ...
    <script src="${pageContext.request.contextPath }/resources/vendors/glightbox/glightbox.min.js"></script>
