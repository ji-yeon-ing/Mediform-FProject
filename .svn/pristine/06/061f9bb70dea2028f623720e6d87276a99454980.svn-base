...
public class PaginationInfoVO<T> {
	...
	private String schdlDep; // 검색 부서
	private T searchVO;	// Tab별 검색 조건을 달리하기위한 flag
	...
	// paginationINfoVO 객체를 만들 때, 한 페이지 당 게시글 수와 페이지 블록 수를 원하는 값으로 초기화 할 수 있다
	...
	public void setCurrentPage(int currentPage) {
		...
		// 마지막 페이지 = (현재 페이지 + (페이지 블록 사이즈 -1)) / ㅠㅔ이지 블록 사이즈 * 페이지 블록 사이즈
		// blocksize * blocksize는 1,2,3,4,5... 페이지 마다 실수 계싼이 아닌 정수 계산을 이용해 endPage를 구하기 위함
